 ...
 * Opcional: @ptexto_entrada
 *
 * RETUNR: @vtexto_salida VARCHAR(45)
 *
 * Funcionalidad: Encripta un texto cualquiera en un una clave cifrada.
 * Dicha clave puede volver a ser desencriptada por la misma función.
*/
